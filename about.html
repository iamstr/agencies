...
<body>
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                <li class="">
                  <a class="nav-link scroll text-uppercase" href="/">Home </a>
                </li>
                ...
                <li class="">
                  <a class="nav-link scroll text-white text-uppercase" href="index#jobs">Jobs</a>
                </li>

                <li class="">
                  <a class="nav-link scroll text-white text-uppercase" href="index#gallery">gallery</a>
                </li>
                <li class="">
                  <a class="nav-link scroll text-white text-uppercase" href="index#contact">Contact Us</a>
                </li>
              </ul>
            </nav>
          </div>
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center text-center">
        ...
        <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
          ...
          <p class="breadcrumb-custom"><a href="index">Home</a> <span class="mx-2">&gt;</span> <span>About
              Us</span></p>
        </div>
      </div>
    </div>
  ...
  <div class="site-section">
    <div class="container">
      <div class="row mb-5">
        ...
        <div class="col-md-6 order-md-1" data-aos="fade">
          ...
          <p>Lelei Prency .E.H.C Limited was founded on the precepts of fully operating as a multi-faceted
            ...
            and shortlisting processes that put great emphasis on retaining the best candidates for our clients.</p>
      ...
      <div class="row mb-5">
        ...
        <div class="col-md-6 order-lg-2 order-md-1" data-aos="fade">
          <div class="text-left pb-1 border-primary mb-4">
            <h2 class="text-primary">Our mission</h2>
          </div>
          <p> Using thought leadership, we search and connect our clients with opportunities in a more valuable,
          ...
          <div class="text-left pb-1 border-primary border-success mb-4">
            <h2 class=""> OUR OBJECTIVE</h2>
          </div>
          <p class="mb-5">As your recruiter of choice, we embrace the fact that there’s no limit in quality of talent
            and human
            resource in East &Central Africa.
            We therefore, have made it our business to source and find the best talent across the continent.Generate
  ...
  <div class="container-fluid pb-5 mb-5" id="partners">
  ...
  <footer class="footer-59391  site-section bg-gradient-primary">
